...
var ClusterEnv = {
  ...
  install: function() {
    this.httpCluster.installByRole() ;
    this.esCluster.installByRole() ;
    this.zkCluster.installByRole() ;
    this.kafkaCluster.installByRole() ;
    this.kafkaConsumerCluster.installByRole() ;
    this.sparknginCluster.installByRole() ;
    this.ringbearerCluster.installByRole() ;
